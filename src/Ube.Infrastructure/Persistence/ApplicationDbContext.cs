...
public class ApplicationDbContext : DbContext, IApplicationDbContext // ? ADD INTERFACE
{
    ...
    public DbSet<VendorRegisterApplication> VendorRegisterApplications { get; set; }
