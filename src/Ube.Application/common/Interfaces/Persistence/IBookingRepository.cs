...
public interface IBookingRepository
{
    ...
    // Distinct ListingUnitIds already booked (Pending/Confirmed) for a
    // listing in a date range - backs seat-map "already taken" display.
    Task<List<Guid>> GetBookedListingUnitIdsAsync(Guid listingId, DateTime startDate, DateTime endDate, CancellationToken ct = default);
