...
public interface ISeasonalPricingRepository
{
    ...
    // unitId is given) that overlap the given date range - used by both
    // checkout pricing and the public price-quote endpoint.
    ...
    // True if any OTHER active rule for the same listing/unit overlaps
    // this range - used to reject ambiguous overlapping rules on write.
